...
export const OPTIONAL_LIVE_CHANNELS: LiveChannel[] = [
  ...
  { id: 'livenow-fox', name: 'LiveNOW from FOX', handle: '@LiveNOWFOX', fallbackVideoId: 'yQ7mP2sV4aZ' },
  { id: 'newsmax', name: 'Newsmax', handle: '@NEWSMAX', fallbackVideoId: 'S-lFBzloL2Y', useFallbackOnly: true },
  { id: 'abc-news', name: 'ABC News', handle: '@ABCNews', fallbackVideoId: 'pQ3vN7sL2aB' },
  ...
  { id: 'rt', name: 'RT', handle: '@RT', fallbackVideoId: 'uJcR8cE9bQk', useFallbackOnly: true },
  ...
  { id: 'record-news', name: 'Record News', handle: '@RecordNews', fallbackVideoId: 'qg8h7r5aX8Y', useFallbackOnly: true },
  ...
  { id: 'wion', name: 'WION', handle: '@WION', fallbackVideoId: 'bT8mK2qW0xZ' },
  ...
  { id: 'arirang-news', name: 'Arirang News', handle: '@ArirangCoKrArirangNEWS', fallbackVideoId: 'qP2mV7sL1aX' },
  { id: 'india-today', name: 'India Today', handle: '@indiatoday', fallbackVideoId: 'sYZtOFzM78M' },
  { id: 'abp-news', name: 'ABP News', handle: '@ABPNews', fallbackVideoId: 'zL8pQ2mN4vA' },
  ...
  { id: 'rudaw', name: 'Rudaw', hlsUrl: 'https://svs.itworkscdn.net/rudawlive/rudawlive.smil/playlist.m3u8', fallbackVideoId: 'v7Qm2zL9pXa', useFallbackOnly: true },
  // Africa
  ...
  { id: 'sabc-news', name: 'SABC News', handle: '@SABCDigitalNews', fallbackVideoId: 'mP3vQ8sL1aZ' },
  ...
  { id: 'tv5monde-info', name: 'TV5 Monde Info', handle: '@TV5MONDEInfo', fallbackVideoId: 'nQ8vL1sX3pB' },
  { id: 'nrk1', name: 'NRK1', handle: '@nrk', fallbackVideoId: 'tP4mQ9sL1xA' },
  { id: 'aljazeera-balkans', name: 'Al Jazeera Balkans', handle: '@AlJazeeraBalkans', fallbackVideoId: 'aQ1mV8sP3zL' },
  // Oceania
