...
export const shareTexts = {
  ...
  linkedin: (data: StoryData) =>
    ...
    `\nData via QADR110 - Open source geopolitical intelligence`,
...
export function getShareUrls(data: StoryData): Record<string, string> {
  ...
  return {
    ...
    reddit: `https://reddit.com/submit?url=${encodeURIComponent(url)}&title=${encodeURIComponent(`${data.countryName} Intelligence Brief - QADR110`)}`,
